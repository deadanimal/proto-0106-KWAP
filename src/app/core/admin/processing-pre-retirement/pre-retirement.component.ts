...
@Component({
  selector: 'app-pre-retirement',
  templateUrl: './pre-retirement.component.html',
  styleUrls: ['./pre-retirement.component.scss']
})
export class PreRetirementComponent implements OnInit {
  ...
  rows: any = [
    ...
    },
    {
      ...
      date: "2019-10-08T01:26:15Z",
      status: "Approved",
      identification_number: "782374878772"
    }
  ]
