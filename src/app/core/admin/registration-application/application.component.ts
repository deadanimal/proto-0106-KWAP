...
import { Application } from 'src/assets/mock/admin-application/application.model'
...
export class ApplicationComponent implements OnInit, OnDestroy {
  ...
  registerFormMessages = {
    ...
    'file_no': [
      { type: 'required', message: 'File number is required' }
    ],
  ...
  ngOnInit() {
    this.registerForm = this.formBuilder.group({
      ...
      file_no: new FormControl('', Validators.compose([
        Validators.required
      ])),
  ...
  getData() {
    this.mockService.getAll('admin-application/application.data.json').subscribe(
      (res) => {
        // Success
        this.tableRows = [...res]
  ...
  confirm() {
    swal.fire({
      title: "Confirmation",
      text: "Are you sure to create this new entry?",
      type: "info",
      buttonsStyling: false,
  ...
  register() {
    swal.fire({
      title: "Success",
      text: "A new entry has been created!",
      type: "success",
      buttonsStyling: false,
